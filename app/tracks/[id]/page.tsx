    ...
    <AppShell>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm opacity-70">Created {new Date(track.created_at).toLocaleString()}</p>
        </div>
        ...
        <section className="space-y-4">
          ...
          {results.map(r => (
            <div key={r.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-2">
